...
public class ProcessorTest {
    ...
    public void findTimestamp1() throws Exception {
        final InputStream stream = new ClassPathResource("timer.out").getInputStream();
        final Processor processor = new Processor(stream, null, null);
        Assert.assertEquals("15:04:05,150", processor.findTimestamp("2017-06-26 15:04:05,150 [rter-1-thread-1] E:           T:                     R: S:      U:           INFO    net.mcfpp.metrics - type=TIMER, name=net.mcfpp.ctn.server.http.HTTP_CTNServlet.CTN requests, count=4, min=146.80763199999998, max=869.43518, mean=186.29656501935514, stddev=36.73430727427362, median=185.081582, p75=185.081582, p95=186.781559, p98=186.781559, p99=186.781559, p999=869.43518, mean_rate=1.4987987556953025E-5, m1=2.964393875E-314, m5=1.4821969375E-313, m15=3.3904063983955295E-130, rate_unit=events/second, duration_unit=milliseconds"));
    }
